...
def index(request):
    languages = ['Hindi', 'Bengali', 'Telugu', 'Marathi', 'Tamil', 'Urdu', 'Gujarati', 'Kannada', 'Malayalam', 'Odia', 'Punjabi', 'Assamese', 'Maithili', 'Santali']
...
This is the conversion of audio speech to text (in English),
then conversion to desired language.

The transcribed text: {transcribed_text}

The translation in your desired language:
{translated_text}
